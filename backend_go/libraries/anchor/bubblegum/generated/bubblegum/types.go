...
func (obj BubblegumEvent) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `BubblegumEventType` param:
	err = encoder.Encode(obj.BubblegumEventType)
	if err != nil {
		return err
	}
	...
	// Serialize `LeafHash` param:
	err = encoder.Encode(obj.LeafHash)
	if err != nil {
		return err
	}
	return nil
...
func (obj *BubblegumEvent) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `BubblegumEventType`:
	err = decoder.Decode(&obj.BubblegumEventType)
	if err != nil {
		return err
	}
	// Deserialize `Version`:
	...
	// Deserialize `LeafHash`:
	err = decoder.Decode(&obj.LeafHash)
	if err != nil {
		return err
	}
	return nil
